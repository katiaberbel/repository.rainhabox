...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.picapaun/data/" ).decode("utf-8"), AddonID)
...
def vimeo(name,url,iconimage):
    tam = len(url)
    base = "plugin://plugin.video.vimeo/play/?video_id="
    baseurl = ""+base+"" ""+url+""
    print(baseurl)
...
def player(name, url, iconimage):
	...
	if url[0] =="m":
		baseurl = "plugin://plugin.video.quasar/play?uri="+url+""
		PlayUrl(name,baseurl, iconimage)
